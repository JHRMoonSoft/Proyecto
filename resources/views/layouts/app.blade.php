      ...
      <div class="main_container">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Requisicion <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index2.html">Listar de RQS</a></li>
            ...
            <!-- /menu footer buttons --><!--
            <div class="sidebar-footer hidden-small"data-placement="top"  >
			    ...
			    <li class="dropdown">
					...
					Configuración<span class="caret"></span>
	   		   	...
	   		   	<ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="/permissions" >Listar Permisos</a></li>
                           	</ul>
			    </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
...
>>>>>>> 8db9a940eb8cb53ab4316b7d5ce99b7782dedac2
