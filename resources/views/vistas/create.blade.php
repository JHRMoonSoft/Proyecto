													...
													<li>
														<div class="block">
															...
															<div class="block_content">
																	...
																	<div class="x_content">
																		<h5>Solicitud OCM penites por facturar<h5>
																		<div class=" panel-default">
																			<div class="table-responsive">
																				<table id="datatable-buttons" class="table table-striped table-bordered ">
																					<thead>
																						...
																						<tr>
																							<td>
																								<div class="form-group filter">
																								  <div id="reportrange" class="pull-center" style="background: #fff; cursor: pointer; padding: 2px 10px; border: 1px solid #ccc">
																									<i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
																									<span>December 30, 2014 - January 28, 2015</span> <b class="caret"></b>
																								  </div>
																								</div>
																			...
																			<div class="table-responsive">
																				<table class="table table-bordered table-hover vmiddle">
																					...
																					<tbody>
																							...
																							<td>
																								<div class="form-group">
																									<input class="form-control input-sm" id="inputsm" value="Orden de compra 0283"type="text">
																								</div>
																							</td>
																							<td>
																								<div class="form-group">
																									<input class="form-control input-sm" id="inputsm" value="15-07-2017"type="text">
																								</div>
																							</td>
